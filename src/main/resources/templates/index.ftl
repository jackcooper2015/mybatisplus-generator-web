...
<body>
                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li class="active"><a href="${base}/index">首页</a></li>
                            <li><a href="${base}/users">用户列表</a></li>
    ...
    <!-- Flot -->
    <script src="${base}/static/js/plugins/flot/jquery.flot.js"></script>
    <script src="${base}/static/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="${base}/static/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="${base}/static/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="${base}/static/js/plugins/flot/jquery.flot.pie.js"></script>

    <!-- Peity -->
    <script src="${base}/static/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="${base}/static/js/demo/peity-demo.js"></script>
    ...
    <!-- jQuery UI -->
    <script src="${base}/static/js/plugins/jquery-ui/jquery-ui.min.js"></script>

    <!-- GITTER -->
    <script src="${base}/static/js/plugins/gritter/jquery.gritter.min.js"></script>

    <!-- Sparkline -->
    <script src="${base}/static/js/plugins/sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="${base}/static/js/demo/sparkline-demo.js"></script>

    <!-- ChartJS-->
    <script src="${base}/static/js/plugins/chartJs/Chart.min.js"></script>
